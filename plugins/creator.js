...
let caption = `👋 Hai *${name} @${who.split("@")[0]}*, Nih Owner *${conn.user.name}* kak`
    await conn.sendButton(m.chat, caption, author, null, [['Reza Ganteng', 'Huuu']], m, { quoted: tag_own, mentions: conn.parseMention(caption) })
}
